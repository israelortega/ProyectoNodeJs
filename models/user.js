/**
*Biblioteca user.js
Biblioteca que contiene la información necesaria para crear un objeto de tipo mongoose
*/
...
var Vacante = mongoose.model("Vacante", vacante_schema)
//y aquí se envia la variable hacia el export
module.exports.User = User;
module.exports.Vacante = Vacante;
